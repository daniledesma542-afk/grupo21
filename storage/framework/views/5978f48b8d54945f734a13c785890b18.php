...
<section class="py-5" style="background-color: var(--blanco-roto); min-height: 80vh;">
    <div class="container">
        ...
        <div class="mb-4">
            <a href="<?php echo e(route('admin.mensajes')); ?>"
               class="btn"
        ...
        <div class="card-aesthetic p-4">
            ...
            <div class="d-flex justify-content-between align-items-start mb-4">
                <div>
                    ...
                    <p class="texto-suave mb-1">
                        <strong>Email:</strong> <?php echo e($mensaje->email); ?>
                    ...
                    <p class="texto-suave mb-0">
                        <strong>Fecha:</strong> <?php echo e($mensaje->created_at->format('d/m/Y H:i')); ?>
            ...
            <?php if(!$mensaje->leido): ?>
                <form method="POST"
                      action="<?php echo e(route('admin.mensaje.leido', $mensaje->id)); ?>"
                      class="mb-4">
                    <?php echo csrf_field(); ?>
            ...
            <div class="mt-4">
                ...
                <?php if($mensaje->respuesta): ?>
                    <div class="p-3 mb-3"
                        ...
                        <p class="mb-0" style="white-space: pre-line;">
                            <?php echo e($mensaje->respuesta); ?>

                        </p>
                    </div>
                <?php endif; ?>

                <form method="POST" action="<?php echo e(route('admin.mensaje.responder', $mensaje->id)); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <textarea
                        ...
                        required><?php echo e(old('respuesta')); ?></textarea>
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario-1\Documents\Herd\grupo21\resources\views/backend/admin/detalle-mensaje.blade.php ENDPATH**/ ?>