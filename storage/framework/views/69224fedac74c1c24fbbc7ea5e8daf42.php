<section class="py-5" style="background-color:#f7f5ef;">
    <div class="container">
            ...
            <div class="carousel-inner">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="tarjeta-producto shadow-sm h-100 d-flex flex-column">
                                <img src="<?php echo e(asset('img/fotos-productos/1781475826_velaCanela.jpg')); ?>" class="img-fluid">
                                <div class="p-3 text-center d-flex flex-column flex-grow-1">
                                    ...
                                    <a href="<?php echo e(route('carrito')); ?>" class="btn btn-dorado-principal mt-auto">
                                        Añadir al carrito
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="tarjeta-producto shadow-sm h-100 d-flex flex-column">
                                <img src="<?php echo e(asset('img/fotos-productos/velaEucalipto.jpg')); ?>" class="img-fluid">
                                <div class="p-3 text-center d-flex flex-column flex-grow-1">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="tarjeta-producto shadow-sm h-100 d-flex flex-column">
                                <img src="<?php echo e(asset('img/fotos-productos/178147518_tarotRider.jpg')); ?>" class="img-fluid">
                                <div class="p-3 text-center d-flex flex-column flex-grow-1">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="tarjeta-producto shadow-sm h-100 d-flex flex-column">
                                <img src="<?php echo e(asset('img/fotos-productos/1781476478_amatista.jpg')); ?>" class="img-fluid">
                                <div class="p-3 text-center d-flex flex-column flex-grow-1">
                ...
                <div class="carousel-item">
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="tarjeta-producto shadow-sm h-100 d-flex flex-column">
                                <img src="<?php echo e(asset('img/fotos-productos/1781476265_kitAuraSuave.png')); ?>" class="img-fluid">
                                <div class="p-3 text-center d-flex flex-column flex-grow-1">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="tarjeta-producto shadow-sm h-100 d-flex flex-column">
                                <img src="<?php echo e(asset('img/fotos-productos/1781476384_jaspe.jpg')); ?>" class="img-fluid">
                                <div class="p-3 text-center d-flex flex-column flex-grow-1">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="tarjeta-producto shadow-sm h-100 d-flex flex-column">
                                <img src="<?php echo e(asset('img/fotos-productos/1781476565_aceiteRosas.jpg')); ?>" class="img-fluid">
                                <div class="p-3 text-center d-flex flex-column flex-grow-1">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="tarjeta-producto shadow-sm h-100 d-flex flex-column">
                                <img src="<?php echo e(asset('img/fotos-productos/1781476738_oraculoDDiosas.jpg')); ?>" class="img-fluid">
                                <div class="p-3 text-center d-flex flex-column flex-grow-1">
        ...
        <div class="text-center mt-5">
            <a href="<?php echo e(url('/productos')); ?>" class="btn btn-dorado-principal px-5 py-3">
                Ver catálogo completo
            </a>
        </div>

    </div>
</section><?php /**PATH C:\Users\Usuario-1\Documents\Herd\grupo21\resources\views/partes/destacados.blade.php ENDPATH**/ ?>