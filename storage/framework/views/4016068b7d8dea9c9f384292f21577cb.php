                    ...
                    <?php if($producto->stock > 0): ?>
                        <form action="<?php echo e(route('carrito.agregar')); ?>" method="POST" class="d-flex align-items-center gap-3">
                            ...
                            <div style="width: 100px;">
                                <input type="number" name="cantidad" class="form-control text-center" value="1" min="1" max="<?php echo e($producto->stock); ?>">
                            </div>
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario-1\Documents\Herd\grupo21\resources\views/detalle_producto.blade.php ENDPATH**/ ?>