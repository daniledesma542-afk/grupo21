...
{{-- Agregamos data-bs-interval para que pase solo cada 4 segundos (4000 ms) --}}
<div id="mainCarousel" class="carousel slide carousel-fade shadow-sm" data-bs-ride="carousel" data-bs-interval="4000">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      ...
      <img src="{{ asset('img/fotos-carrusel/tarot.png') }}" class="d-block w-100 carousel-img" style="object-fit: cover; height: 45vh;">
    ...
    <div class="carousel-item">
      <div class="overlay-estetico"></div>
      <img src="{{ asset('img/fotos-carrusel/cristales.png') }}" class="d-block w-100 carousel-img" style="object-fit: cover; height: 45vh;">
      <div class="carousel-caption d-block texto-animado">
    ...
    <div class="carousel-item">
      <div class="overlay-estetico"></div>
      <img src="{{ asset('img/fotos-carrusel/meditacion.png') }}" class="d-block w-100 carousel-img" style="object-fit: cover; height: 45vh;">
      <div class="carousel-caption d-block texto-animado">
    ...
    <div class="carousel-item">
      <div class="overlay-estetico"></div>
      <img src="{{ asset('img/fotos-carrusel/velas.png') }}" class="d-block w-100 carousel-img" style="object-fit: cover; height: 45vh;">
      <div class="carousel-caption d-block texto-animado">
