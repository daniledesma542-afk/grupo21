...
CREATE DATABASE IF NOT EXISTS `grupo21` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_ai_ci */;
USE `grupo21`;
...
INSERT INTO `productos` (`id`, `categoria_id`, `nombre`, `descripcion`, `precio`, `stock`, `imagen`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(4, NULL, 'Tarot Rider', 'El clásico indiscutido. Tarot Rider-Waite. Simbología vintage y la mejor puerta de entrada al tarot.', 11200.00, 7, 'img/fotos-productos/1781475918_tarotRider.jpg', '2026-06-15 01:25:18', '2026-06-25 21:48:24', NULL),
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('kArTH708CJzGirPQ4dNgzkfyENkJxsvvfyOAoXnv', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '', 1781745738);
...
INSERT INTO `ventas_cabecera` (`id`, `fecha_venta`, `user_id`, `estado`, `total`, `created_at`, `updated_at`) VALUES
	...
	(19, NULL, 2, 'carrito', 0.00, '2026-06-25 22:27:42', '2026-06-25 23:06:10');
